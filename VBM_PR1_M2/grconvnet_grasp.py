...
class GraspDetectionNet():
    ...
    def load_and_preprocess_image(self, rgb_img, depth_img):
        ...
        rgb_img_cropped = self.crop_image(rgb_img)
        depth_img_cropped = self.crop_image(depth_img)
    ...
    def format_inputs(self, rgb_img, depth_img):
        ...
        rgb_img = rgb_img = rgb_img.transpose((2, 0, 1)) 
    ...
    def testing_model(self):
        rgb_img = imread(r"/home/farhan/Desktop/VBRM_project/grasp_model/test_dataset_cornel/pcd0138r.png")
        depth_img = imread(r"/home/farhan/Desktop/VBRM_project/grasp_model/test_dataset_cornel/pcd0138d.tiff")
